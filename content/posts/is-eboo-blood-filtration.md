---
title: "Is EBOO Blood Filtration?"
...
<img src="/images/blog/eboo-vs-dialyzer-plumbing.svg" alt="Side-by-side schematic. In hemodialysis, blood runs inside the fibers and dialysate runs counter-current in the jacket, so solutes diffuse out of the blood into the dialysate. In EBOO, blood runs in the jacket, gas runs inside the fibers, there is no dialysate, and only a thin plasma ultrafiltrate drips out as waste." style="width:100%;height:auto;max-width:920px" />
...
<img src="/images/blog/eboo-membrane-cutoff.svg" alt="Size scale. The membrane cutoff sits around 3 nanometers. Only gas, water, and small solutes under about 1 nanometer cross to waste. Albumin, antibodies, LDL, microplastics, and red cells are all larger than the cutoff and are retained, returning to the patient." style="width:100%;height:auto;max-width:880px" />
...
By contrast, [therapeutic plasma exchange](/tpe) runs on FDA-cleared apheresis devices with built-in safety monitoring, carries guideline-categorized indications from the American Society for Apheresis, and is backed by decades of use, up to and including the AMBAR trial in Alzheimer's disease.
...
*If you have questions about therapeutic plasma exchange and whether it may be right for you, you can [schedule a free consultation through Global Apheresis](https://www.globalapheresis.com/free-consultation).*
