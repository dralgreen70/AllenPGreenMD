---
title: "What Joe Rogan Got Right About Plasmapheresis — And What to Know Before You Pick Up the Phone"
metaTitle: "Joe Rogan and Plasmapheresis"
date: "2026-03-28"
...
description: "A physician who performs TPE weekly answers the questions Joe Rogan's post raised: what it costs, how it works, whether it's safe, and who it's for."
...
This is what happens when [therapeutic plasma exchange](/tpe) enters the mainstream. The interest arrives all at once, and the clinical context takes longer to catch up. So rather than writing another full explainer on what TPE is (I've done that elsewhere on this site, and I published a detailed response on the [Global Apheresis blog](https://www.globalapheresis.com/blog/joe-rogan-plasmapheresis) as well), I want to answer the questions I'm actually seeing.
...
I've since written a fuller answer to this question, walking through the published safety data and the questions worth asking any clinic: [is plasma exchange safe?](/blog/athens-plasma-exchange-safety)
...
If you're considering TPE, whether because of Rogan's post, the [Goop article](/blog/goop-plasma-exchange), or your own research, here's what I'd want you to ask any provider before booking:
