---
title: "AMBAR Part 3: Plasma Exchange Slows Alzheimer's Decline Regardless of Amyloid Status"
metaTitle: "AMBAR Part 3: Beyond Amyloid"
date: "2026-01-05"
...
Now in Part 3, we explore the most surprising discovery from AMBAR and what it means for the future of Alzheimer's treatment.

---

## The Amyloid-Negative Finding: A Game-Changer

Perhaps the most important finding from AMBAR came not from the original 2020 publication, but from a follow-up analysis published as a Letter to the Editor in 2022.
...
<div class="post-callout-stat"><strong>~30%</strong> of patients (~90 people) were amyloid-negative</div>
...
This discovery has profound implications for how we understand and treat Alzheimer's disease.

**1. It's not just about amyloid.** If plasma exchange worked solely by removing amyloid from the brain, it shouldn't work in amyloid-negative patients. The fact that it does means other mechanisms are at play.
...
In the interest of balanced reporting, it's important to acknowledge the limitations of the AMBAR study and the uncertainties that remain. Science requires honest evaluation of both strengths and weaknesses.

### Study Limitations

**Industry sponsorship.** The study was funded by Grifols, which manufactures therapeutic albumin. While the trial was independently conducted with oversight from academic investigators and a Data Safety Monitoring Committee, the potential for bias exists.

**Single trial.** Until the Argentina study, AMBAR was a single trial. While the results were internally consistent and showed effects across multiple outcomes, medicine generally requires replication before establishing new treatments.

**Sample size.** At 322 patients, AMBAR was adequately powered for its primary endpoints but smaller than the pivotal trials for competing therapies.

**Treatment arm ambiguity.** None of the three treatment arms (low-albumin, low-albumin+IVIG, high-albumin+IVIG) showed clear superiority when analyzed separately. The significant effects were seen when all three were pooled, making it unclear which specific protocol is optimal.

**Dropout rates.** While similar to other AD trials, the dropout rates of 34–35% in the IVIG-containing arms and 20–22% in the non-IVIG arms are substantial, likely reflecting procedural burden and potential IVIG side effects.

**Biomarker inconsistency.** The CSF biomarker results don't provide a clear mechanistic explanation for the clinical effects, particularly in mild AD patients.

**Blinding challenges.** While the study used sham plasma exchange to maintain blinding, procedural studies are inherently challenging to blind perfectly. However, the high completion rate in the placebo group (80%) suggests blinding was reasonably effective.
...
The AMBAR study demonstrated that plasma exchange with albumin replacement can slow cognitive and functional decline in Alzheimer's disease patients, with effect sizes of 52–71% across multiple outcome measures. These findings have been independently validated in a real-world cohort from Argentina.

<div class="post-callout-data">
<div class="post-callout-label">AMBAR Clinical Results — Summary</div>
<div class="post-callout-stats">
<div class="post-callout-stat"><strong>52%</strong> less decline in activities of daily living <span>(p=0.03)</span></div>
<div class="post-callout-stat"><strong>66%</strong> less cognitive decline <span>(p=0.06)</span></div>
<div class="post-callout-stat"><strong>71%</strong> less decline on CDR-Sum of Boxes <span>(p=0.002)</span></div>
<div class="post-callout-stat"><strong>Near stabilization</strong> on clinical global impression <span>(p&lt;0.0001)</span></div>
...
*The AMBAR study may have stumbled onto something bigger than anyone realized.*

---

## Continue the Discussion

This concludes our three-part analysis of the AMBAR study. If you found this series valuable, I'll be publishing additional content exploring practical treatment considerations for patients and families, the anti-aging hypothesis behind AMBAR's benefits, and emerging research on plasma exchange for longevity and cognitive optimization.

**Read the Complete Series:**

<div class="post-series-nav">
<a href="/blog/ambar-study-part-1" class="post-series-card">
...
<span class="post-series-title">Biomarkers, Validation, and FDA Comparison</span>
</a>
<a href="/blog/ambar-study-part-3" class="post-series-card post-series-current">
...
- Boada M, Lopez OL, Olazaran J, et al. [A randomized, controlled clinical trial of plasma exchange with albumin replacement for Alzheimer's disease: Primary results of the AMBAR Study.](https://alz-journals.onlinelibrary.wiley.com/doi/10.1002/alz.12137) Alzheimer's Dement. 2020;16:1412-1425.
- Costa M, Boada M. Letter to the Editor: AMBAR: A Therapeutical Approach for Alzheimer's Disease Patients Regardless of Amyloid Status. J Prev Alz Dis 2023;1(10):148-149. Published online November 4, 2022, [http://dx.doi.org/10.14283/jpad.2022.100](http://dx.doi.org/10.14283/jpad.2022.100)
- Taragano F, Seinhart D, Epstein P, et al. [A real-world study on the safety and efficacy of therapeutic plasma exchange in patients with Alzheimer's disease.](https://pubmed.ncbi.nlm.nih.gov/40928812/) Journal of Alzheimer's Disease 2025;108(1):129-141.
- Ace Alzheimer Center Barcelona. "Alzheimer's disease, current treatments and the role of Plasma exchange." ASFA 2024 Conference Webinar. February 7th, 2024.
